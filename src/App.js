...
function App() {
  ...
  const intialHomeScore = 0;
  const initalAwayScore = 0;
  const [homeScore, setHomeScore] = useState(intialHomeScore);
  const [awayScore, setAwayScore] = useState(initalAwayScore);
